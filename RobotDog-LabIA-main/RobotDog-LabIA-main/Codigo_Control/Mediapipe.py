...
with mp_hands.Hands(
  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        ...
        with open('/home/labia-001/ROBOTDOG/unitree_legged_sdk/example_py/command.txt', 'w') as f: # write command to file
            if orient_ratio <0.5:
                print('normal')
        ...
        print('bae')
        with open('/home/labia-001/ROBOTDOG/unitree_legged_sdk/example_py/command.txt', 'w') as f:
            f.write("n")
